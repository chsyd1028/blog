...
function initImg(){
    if ( $('.iso-box-wrapper').length > 0 ) {
        ...
        $('.filter-wrapper li a').click(function(){
            ...
            if (filterValue == '.project'){panelIndex = 1;}
            if (filterValue == '.me'){panelIndex = 2;}
            if (filterValue == '.photo'){panelIndex = 3;}
            if (filterValue == '.contact'){panelIndex = 4;}
...
(function() {
    ...
    hm.src = "https://hm.baidu.com/hm.js?0cb2bbe6306067ef688a1fa687d95d12";
